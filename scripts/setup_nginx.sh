...
# Script pour installer et configurer Nginx pour le dashboard de Dropshipping Crew AI
...
echo -e "${GREEN}== Installation et configuration de Nginx pour le dashboard de Dropshipping Crew AI ==${NC}"

# Vérifier si Nginx est déjà installé
if command -v nginx &> /dev/null; then
    echo -e "${YELLOW}Nginx est déjà installé. Vérification de la version...${NC}"
    nginx -v
else
...
echo -e "${GREEN}Création d'un fichier HTML basique pour le dashboard...${NC}"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row" id="servicesStatus">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card status-card status-partial">
                                    <div class="card-body">
                                        <h5 class="card-title">Data Analyzer</h5>
                                        <p class="card-text">Partiellement implémenté</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
chmod +x /var/www/html/dashboard/index.html
